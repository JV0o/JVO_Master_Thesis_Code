...
class cc_anane_bb(object):
    ...
    def cc_cmodel_odes(self,t,y,comp_mod,X:float,Fs_feed:float,returns:str='dydt'):
        ...
        for n in range(0,compartments):
            ...
            vars()['qS'+str(n)] = self.qS_max/(1+vars()['A'+str(n)]/self.Ki_a)*(vars()['S'+str(n)])/(vars()['S'+str(n)]+self.Ks)
            ### actual maintenance coefficient
            ...
            ### specific substrate uptake rate of the overflow metabolism
            vars()['qS_of'+str(n)] = self.pA_max*vars()['qS'+str(n)]/(vars()['qS'+str(n)]+self.Kap)
            ### specific substrate uptake rate of the oxidative metabolism
            vars()['qS_ox'+str(n)] = (vars()['qS'+str(n)]-vars()['qS_of'+str(n)])*vars()['O'+str(n)]/(vars()['O'+str(n)]+self.Ko)
            
            vars()['qS_A'+str(n)] = self.qA_max/(1+vars()['qS'+str(n)]/self.Ki_s)*(vars()['A'+str(n)])/(vars()['A'+str(n)]+self.Ksa)
            ### specific substrate uptake rate of the anabolic overflow metabolism
            ...
            ### theoretical specific acetate consumption rate
            vars()['pA'+str(n)] = vars()['qS_of'+str(n)]*self.Ysa
            ...
            ### specific acetate consumption rate
            vars()['qA'+str(n)] = vars()['pA'+str(n)]-vars()['qS_A'+str(n)]
            #vars()['qA_c'+str(n)] = vars()['qA_c_an'+str(n)]+ vars()['qA_c_en'+str(n)]
            ### specific oxygen consumption rate
            vars()['qO'+str(n)] = (vars()['qS_ox'+str(n)]-self.qm_max)*self.Yso+vars()['qS_A'+str(n)]*self.Yao
            ...
            vars()['mu'+str(n)] = (vars()['qS_ox'+str(n)]-self.qm_max)*self.Ysx_ox+vars()['qS_of'+str(n)]*self.Ysx_of+vars()['qS_A'+str(n)]*self.Yax
            # append rates
            rates = np.append(
                rates,[
                    vars()['OTR'+str(n)],
        ...
        for n in range(0,compartments):
            ...
            vars()['dAdt'+str(n)]  = vars()['dAdt_in'+str(n)] - vars()['dAdt_out'+str(n)] + vars()['qA'+str(n)] * X
